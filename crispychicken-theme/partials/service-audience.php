<?php
/**
 * Template part for displaying audience development in page-services.php
 *
 */

?>

<section class="page--services-grid-container">
  <div class="page--work-grid">
    ...
    <div class="page--client-item">
      ...
      <div class="item-text">
        <img class="client-logo" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/clients/leatherhead-logo.png" /></a>
      </div>
      </a>
    </div>
  </div>
