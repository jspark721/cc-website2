  ...
  <div class="client-video--grid">
    <div class="client-video--item">
      <div class="client-video--thumbnail thumbnail-bg">
        <img class="work-video" src="<?php echo get_site_url(); ?>/wp-content/uploads/leatherhead-project1.jpg" />
      </div>
      <div class="client-video--textarea">
        <div class="client-video-text">
          <p class="sm-cap"><span>project</span></p>
          <h3>#WhereWePlay Ball UGC Campaign</h3>
        </div>
        <div class="client--item-overlay">
          <p>Ideation & Project Management</p>
        </div>
      </div>
    </div>
    <div class="client-video--item">
      <div class="client-video--thumbnail thumbnail-bg">
        <video autoplay muted loop class="work-video">
          <source src="<?php echo get_site_url(); ?>/wp-content/uploads/leatherhead-project2.mp4" type="video/mp4">
        </video>
      </div>
      <div class="client-video--textarea">
        <div class="client-video-text">
          <p class="sm-cap"><span>project</span></p>
          <h3>World Cup Soccer Video</h3>
        </div>
        <div class="client--item-overlay">
          <p>Ideation, Production & Editing</p>
        </div>
      </div>
    </div>
    <div class="client-video--item">
      <div class="client-video--thumbnail thumbnail-bg">
        <img class="work-video" src="<?php echo get_site_url(); ?>/wp-content/uploads/leatherhead-project3.jpg" />
      </div>
      <div class="client-video--textarea">
        <div class="client-video-text">
          <p class="sm-cap"><span>project</span></p>
          <h3>Star Wars Graphic</h3>
        </div>
        <div class="client--item-overlay">
          <p>Design</p>
        </div>
